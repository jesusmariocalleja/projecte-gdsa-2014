...
eventsTagsList = getEventsTags("TF_IDF.csv")  # Llegim la llista on tenim tots els tags per cada event

print ("Getting images to classify")
imagesList = getImages("id_tags.csv")  # Llegim la llista amb les imatges i els tags que ens passa el descriptor
